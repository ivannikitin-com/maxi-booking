	...
	<div id="primary" class="content-area">
		...
		<?php
			...
			if ( is_plugin_active( 'advanced-custom-fields-pro/acf.php' ) ) :
				...
				if ( $banner ) :
		?>
			<div class="top-big page reviews-top" style="background-image: url(<?php echo $banner['bg']; ?>);">
				<div class="container">
					<div class="row">
						...
						<div class="col-md-6"><p class="h2 left white-col xs-center sm-center"><?php echo $banner['text']; ?></p></div>
					</div>
				</div>
			</div>
			<?php endif; ?>
		...
		while ( have_posts() ) :
			...
			get_template_part( 'template-parts/page/content', 'review' );
